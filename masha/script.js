document.querySelector('#masha').addEventListener('click', () => document.getElementById('about').scrollIntoView());


const ctx = document.querySelector('#heart').getContext("2d");
const cw = ctx.width = 250;
const ch = ctx.height = 250;
